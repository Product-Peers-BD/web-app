...
import { Bookmark, Check, Heart, Link2, MessageCircle } from 'lucide-react';
import { useState } from 'react';

import { Button } from '@workspace/ui/components/button';
import { cn } from '@workspace/ui/lib/utils';

interface CaseStudyEngagementBarProps {
	title: string;
	likeCount: number;
	commentCount: number;
}
...
export function CaseStudyEngagementBar({
	title,
	likeCount,
	commentCount
}: CaseStudyEngagementBarProps) {
