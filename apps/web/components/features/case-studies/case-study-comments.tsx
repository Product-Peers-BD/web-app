...
import type { CaseStudyComment } from '@/types/case-study';
import { formatCaseStudyDate } from '@/utils/format-case-study-date';
	...
	return (
		<div className="flex flex-wrap items-center gap-1.5">
			...
			<span className="font-mono text-[10px] text-muted-foreground">
				{formatCaseStudyDate(postedAt)}
			</span>
		</div>
	);
}

export function CaseStudyComments({ comments }: CaseStudyCommentsProps) {
	return (
