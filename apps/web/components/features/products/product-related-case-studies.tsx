...
import type { ProductRelatedCaseStudy } from '@/types/product';

interface ProductRelatedCaseStudiesProps {
	caseStudies: ProductRelatedCaseStudy[];
}

export function ProductRelatedCaseStudies({
	caseStudies
}: ProductRelatedCaseStudiesProps) {
